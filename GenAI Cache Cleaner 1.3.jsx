(function () {
    ...
    checkAllGroup.spacing = 10;
    var checkAllCheckbox = checkAllGroup.add("checkbox", undefined, "Check All Folders");
    ...
    checkAllCheckbox.onClick = function() {
        ...
        for (var i = 0; i < entries.length; i++) {
            if (entries[i].checkbox.enabled) {
                entries[i].checkbox.value = checkState;
            }
        }
    };
